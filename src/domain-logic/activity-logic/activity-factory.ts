/**
 * Activity factory. Constructs a fresh Activity with neutral weight and empty feedback history.
 * The recency boost is NOT baked into the stored weight here; it is computed at runtime by effectiveWeight() so the boost fades naturally over 7 days without requiring any scheduled work. 
 */
