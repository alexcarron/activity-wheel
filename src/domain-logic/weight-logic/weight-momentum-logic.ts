 ...
 * Rationale: repeated actions in the same direction feel more intentional than a single click. Momentum rewards consistency without letting it run away.
 * Rules:
 ...
 * `prevStreak` convention (signed integer): > 0  consecutive accepts/boosts < 0  consecutive rejects = 0  neutral / just started 
 */
