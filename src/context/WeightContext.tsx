 ...
 * Every component that calls a weight function must be inside a <WeightProvider>. The context is NEVER undefined. Consuming it outside a provider throws immediately so bugs surface early.
 * Usage: const ctx = useWeightContext(); const eff = effectiveWeight(activity, now, ctx); 
 */

import { createContext, useContext, type ReactNode } from 'react';
import type { GlobalWeightContext } from '../domain-logic/weight-logic/weight-types';
...
/**
 * Returns the current GlobalWeightContext. Throws if called outside a <WeightProvider>. The context is never allowed to be undefined. 
 */
